...
class SubSponsor extends React.Component {
    constructor(props) {
        super(props);
    ...
    instantiateContract() {
        ...
        this.state.web3.eth.getAccounts((error, _accounts) => {
            ...
            this.setState({
                accounts: _accounts,
                form_addr_spon: _accounts[0],
                formSpon_addr_spon: _accounts[0]
            });
            ...
            incroSponContract.deployed().then((instance) => {
                ...
                this.state.web3.eth.getAccounts((error, accounts) => {
                    ...
                    this.setState( {
                        form_addr_spon: accounts[0],
                        formSpon_addr_spon: accounts[0]
                    });
                });
            }); 
        });
                    ...
                    <div className='row'>
                        <div className='col-lg-12 col-md-12 col-sm-11 col-xs-10'>
                            ...
                            <h4 className='text_Campaign'>
                                From here, you can sponsor a participant.
                            </h4>
                        </div>
                    </div>
                </div>
                ...
                <div className="subMenuHead">
                    ...
                    <div className='row'>
                        <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                            <h4 className='text_Campaign'>Select the campaign on the left, then a participant, and then you can enter your donation amount.</h4>
                            <h4 className='text_Campaign'>After you donate money will be moved into an escrow amount</h4>
                            <br/>
                            <h5  className='text_Campaign'>
                            Current total escrow balance: {this.state.form_acct_bal_wei} (in wei) or {this.state.form_acct_bal_usd} (in usd)
                            </h5>
                        </div>
                    </div>
                    <hr className='line_Campaign' />
